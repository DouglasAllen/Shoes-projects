...
module Swt
  ...
  module Widgets
    ...
    java_import 'org.eclipse.swt.widgets.ProgressBar'
  ...
  module Layout
    java_import 'org.eclipse.swt.layout.FormAttachment'
    java_import 'org.eclipse.swt.layout.FormData'
    java_import 'org.eclipse.swt.layout.FormLayout'
  end
  ...
  def self.display
    @display ||= begin
      ...
      # clipboard class must be java_imported after the display is created
      Swt::DND.send(:java_import, 'org.eclipse.swt.dnd.Clipboard')
      display
    end
  end
